...
public class StoreReportRVAdapter extends RecyclerView.Adapter<StoreReportRVAdapter.ExpenseViewHolder> {
...
//    }
    ...
    public StoreReportRVAdapter(Cursor cursor, Context context) {
        mCursor = cursor;
        mContext = context;
//        mListener = listener;
    }
    ...
    @Override
    public StoreReportRVAdapter.ExpenseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(mContext).inflate(R.layout.expense_storereport_item, parent, false);
    ...
    static class ExpenseViewHolder extends RecyclerView.ViewHolder {
        ...
        public ExpenseViewHolder(View item) {
            ...
            this.storeName = item.findViewById(R.id.esr_tv_storeName);
            this.catIcon = item.findViewById(R.id.esr_iv_catIcon);
            this.totalValue = item.findViewById(R.id.esr_tv_total);
